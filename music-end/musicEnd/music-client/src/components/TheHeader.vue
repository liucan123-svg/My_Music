 <template>
  <div class="the-header">
    <div class="header-logo" @click="goHome">
      <svg class="icon">
        <use xlink:href="#icon-erji" style="color:LightBLue"></use>
      </svg>
      <span style="color:LightBLue">一间酒馆</span>
    </div>
    

    <ul class="navbar" margin-left:px>
      <li
      ...
      <li>
        <div class="header-search" margin-left:70px>
          <input
            type="text"
            placeholder="搜索音乐"
